...
export default function SearchBar({ setHotels }: { setHotels: Dispatch<SetStateAction<HotelDataType[]>> }) {
    ...
    return (
        <div className="left-[50%] max-w[1100px] absolute block" style={{ transform: "translate(-50%,30px)", width: "calc(80% - 10px)" }}>
            <form className='m-0 p-0' action={(data) => {
                ...
                <div className='flex box-border relative w-full'>
                        ...
                        <div className='rounded-none bg-white self-center box-border w-full p-2'>
                            <div className='flex relative isolate  '> {/* border border-indigo-500 */}
                                <div className=' items-center flex flex-grow w-full'>
                                    ...
                                    <input className="z-10 input join-item bg-base-100 border-l-none text-[14px] font-bold leading-5 width-full overflow-hidden overflow-ellipsis" placeholder="Destination..." />
                    ...
                    <div className='flex-auto ml-0 w-[27%] flex'>
                        <div className='rounded-none bg-white self-center box-border w-full p-2'>
                            <div className='flex relative isolate  '> {/* border border-indigo-500 */}
                                <div className=' items-center flex flex-grow w-full'>
                            ...
                            <div className='flex relative isolate  '> {/* border border-indigo-500 */}
                                <div className=' items-center flex flex-grow w-full'>
                                    <div className="indicator">
                                        ...
                                        <button disabled={isPending} className="btn join-item" type='submit'>{isPending ? null : "Search"}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
