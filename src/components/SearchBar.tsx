...
<div className="relative block">
            ...
            <form className='flex flex-wrap justify-center'>
                    <div className='w-full px-2 mb-4 sm:w-[27%] sm:mb-0'>
                        <div className='rounded-none bg-white self-center box-border w-full p-2'>
                             {/* border border-indigo-500 */}
                                <div className=' items-center flex flex-grow w-full'>
                                    ...
                                    <input type='text' className="input join-item bg-base-100 border-l-none text-[14px] font-bold leading-5 width-full overflow-hidden overflow-ellipsis" placeholder="Destination..." />
                    ...
                    <div className='w-full mx-2 mb-4 sm:w-[27%] sm:mb-0 bg-white'>
                        <div className='p-2 rounded-none '>
                            <div className='flex items-center cursor-pointer'> {/* border border-indigo-500 */}
                                <div className=' items-center flex flex-grow w-full mt-[3px]'>
                    ...
                    <div className='p-2'>
                    <button className="btn btn-primary w-64 md:w-full">Search</button>
                    </div>
        ...
        <div className="max-w-[1100px] mx-auto pt-64">
            <div className="relative block">
                <form className="flex flex-wrap justify-center">
                    <div className="w-full px-2 mb-4 sm:w-[27%] sm:mb-0">
                        <div className="bg-white p-2 rounded-none">
                    ...
                    <div className="w-full px-2 sm:w-[27%]">
                        <div className="bg-white p-2 rounded-none">
                            <div className="flex items-center">
                                <span className="w-5 align-top" aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
